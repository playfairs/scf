...
extern "C"
{
    ...
    typedef scf_status (*scf_kdf_derive_fn)(
        void *state,
    ...
    SCF_API scf_status
    scf_kdf_derive(scf_kdf_context *context,
                   scf_const_buffer password,
                   scf_const_buffer salt,
                   scf_buffer output);
    SCF_API scf_status
    scf_kdf_reset(scf_kdf_context *context);
    SCF_API void
    scf_kdf_context_destroy(scf_kdf_context *context);
